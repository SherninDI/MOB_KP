...
public class BluetoothConnectHandler {
    ...
    private synchronized void setState(int state) {
        ...
        bluetoothHandler.obtainMessage(DataActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = bluetoothHandler.obtainMessage(DataActivity.MESSAGE_DEVICE_NAME);
    ...
    private void connectionFailed() {
        setState(STATE_NONE);
        Message msg = bluetoothHandler.obtainMessage(DataActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(DataActivity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        bluetoothHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = bluetoothHandler.obtainMessage(DataActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(DataActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        bluetoothHandler.sendMessage(msg);
    }
...
//                Log.d(TAG, "sock" + String.valueOf(socket.getRemoteDevice()));
//
//            } catch (IOException e) {
    ...
    private class ConnectedThread extends Thread {
            ...
            while (!stop) {
                try {
                    ...
                    if (availableBytes > 0) {
                        ...
                        if (bytes > 0) {
                            bluetoothHandler.obtainMessage(DataActivity.MESSAGE_READ, bytes, -1, buffer)
                                    .sendToTarget();
                        }
                    }
        ...
        public void write(byte[] buffer) {
            try {
                ...
                bluetoothHandler.obtainMessage(DataActivity.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
